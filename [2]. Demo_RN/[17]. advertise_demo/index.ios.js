       ...
       return(
          <View style={styles.container}>
             <ScrollView
                 ...
                 // 停止拖拽
                 onScrollEndDrag={this.onScrollEndDrag1}
             >
               {this.renderAllImage()}
             </ScrollView>
            {/*返回指示器*/}
   ...
   onScrollEndDrag1(){
    ...
    renderAllImage(){
        ...
        for(var i=0; i<imgsArr.length; i++){
            ...
            // 创建组件装入数组
            allImage.push(
                //这里的图片是放在Xcode工程 Images.xcassets里的资源
...
AppRegistry.registerComponent('component_demo', () => ScrollViewDemo);
